...
class LocationManager: NSObject, ObservableObject {
    ...
    override init() {
        super.init()
        locationManager.desiredAccuracy = kCLLocationAccuracyBest  //位置情報に精度を最高に
        locationManager.distanceFilter = 100 //更新する間隔（100mごとに）
        locationManager.requestWhenInUseAuthorization() //位置情報の使用許可
